...
<a:asi_byztik:791065129264742403> Toplam Erkek Kayıtların: \`${erkek}\`
<a:asi_byztik:791065129264742403> Toplam Kadın Kayıtların: \`${kadın}\``)
.setFooter(`Believe Bot`) // evet bilerek kaldırmadım ayriyetten sıfırdan yazdım :)
...
<a:asi_byztik:791065129264742403>  Toplam Erkek Kayıtların: \`${erkek1}\`
<a:asi_byztik:791065129264742403>  Toplam Kadın Kayıtların: \`${kadın1}\``)
.setFooter(`Believe Bot`) // evet bilerek kaldırmadım ayriyetten sıfırdan yazdım :)
